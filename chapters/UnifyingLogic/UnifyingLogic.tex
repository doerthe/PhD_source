...
The semantics of 
RIF Core and its different extensions is defined independently of \rdf but the standard also specifies a way to semantically integrate \rdf to RIF~\cite{rifrdf}. 
