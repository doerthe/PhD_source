...
\subsection{Open vs. closed world}
...
%  have a clearly defined semantics which enables us to unambiguously determine the meaning of a statement. 
 ...
 Another desirable property of a \emph{Unifying Logic} we have not discussed yet is its connection to the layers on top of it:
...
\item \textbf{Connection of the logical layers:} %Connect the logical layers:} 
...
\hyp{Hypothesis 2}{Existing interpretations differ in their understanding of implicit quantification and this difference can be 
