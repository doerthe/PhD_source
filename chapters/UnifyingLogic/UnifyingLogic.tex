...
Semantic Web forward. We therefore also expect from the proof layer based on the unifying logic that it can be used in different scenarios which preferably go beyond the establishment of trust. 
...
\item \textbf{Built on \rdf:} The \emph{Unifying Logic} should be \emph{syntactically} and \emph{semantically} compatible with \rdf.
