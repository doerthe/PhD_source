...
\hyp{Hypothesis 1.3:}{\nthreelogic can be used to combine SPARQL querying and reasoning over OWL ontologies in practical use cases.}
...
\hyp{Hypothesis 1.4:}{It is possible to express and process proofs using \nthreelogic and these proofs can be used for practical applications.} 
