...
\hyp{Research Question 3}{Can the  semantics of \nthreelogic be defined such that it is compatible to \rdf?}
%\textbf{Hypothesis 2} \textit{The semantics of  \nthreelogic can be formally specified consistent to the \wwwc team submission and .}

To answer this research question, we need to take a closer look to the semantics of \rdf \cite{RDFSemantics}. This is formally defined by a model theory which
