...
To understand the difference, take a look at the following example:
% 
...
\end{center}
So, it in case the statement means that Kurt does not believe in the existence of unicorns. The two interpretations are fundamentally different and it is important where we put 
