...
Here, we do not follow this approach for a specific reason: %The reason for not doing that 
%not directly 
...
\todo{make a bridge between names graphs and citations in \nthree: maybe I can motivate the way I handle them here to be able to cover more of the options listed in TriG semantics?}