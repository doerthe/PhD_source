...
% 
% Here we would like to know whether the differences we How do they impact 
...
\section{Implementing the attribute grammar}\label{imp}
...
\section{Critical formulas}\label{results}
\begin{table}
\begin{center}
\begin{tabular}{rrrr}
\hline
...
\subsection{Distribution of Cases}\label{cases}
