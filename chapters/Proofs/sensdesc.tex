...
%      \parbox{10cm}{\em #1}\hspace*{1cm}(\Roman{quotecount})\\[0.5cm]}
% 
% \usepackage{url}
% \usepackage{xspace}
...
% \newcommand{\da}[1]{\noindent\textcolor{blue}{{\bf \{DA}: #1{\bf \}}}}
% \newcommand{\bdm}[1]{\noindent\textcolor{green}{{\bf \{BDM}: #1{\bf \}}}}
% 
% %comments pieter
% \newcommand{\pieter}[1]{{\textbf{\color{green}\footnote{\color{green}\textbf{Pieter: #1}}}}}
% 
...
% \title{SENSdesc: Connect Sensor queries and Context}
% \author{
% \authorname{
% D\"orthe Arndt\sup{1}, Pieter Bonte\sup{2}, Alexander Dejonghe\sup{2}, 
% Ruben Verborgh\sup{1},\\ Filip De Turck\sup{2} and Femke Ongenae\sup{2}}
% \affiliation{\sup{1}IDLab, Department of Electronics and Information Systems, Ghent University -- imec}
% \affiliation{\sup{2}IDLab, Department of Information Technology, Ghent University -- imec}
% \email{doerthe.arndt@ugent.be}
% }
% 
% 
% 
...
\end{lstlisting}
\footnotetext{In this and all the following listings the dots (...)
...
for which in OWL RL only supports the subclass version. %There is for example a rule in OWL RL to draw from the triples
\begin{lstlisting}[
  float=t,
...
{?D owl:equivalentClass ?C.
 ...
 \end{lstlisting}
 \footnotetext{
  In the actual implementation we have extra rules to handle \texttt{owl:equivalentClass}. 
  We just added its handling to this rule to make our example self-explaining.}
