...
In the next section, we give a short introduction to Web APIs, Web services and their descriptions. %discuss the background necessary to understand this chapter, in particular %Web services, Web APIs and their descriptions to put our work in context with existing technology.
...
\label{sec:ProofAnatomy} \todo{here is a label, check whether we need to link to the previous chapter instead}
