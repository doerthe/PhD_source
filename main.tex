...
\chapter{Semantics of Notation3}
\input{chapters/N3/Syntax}
\input{chapters/N3/Finding_the_meaning}
\input{chapters/N3/directsemantics}
\section{Elaboration Semantics for N3}


\chapter{Notation3 and other frameworks}
\section{OWL}
\section{SPARQL}
\section{RIF}
...
\chapter{Proofs and exchange of proofs}
...
\chapter{Going beyond first order logic: expressing changes}
\section{Weighted Transition Logic}
\chapter{N3 as unifying Logic}
\chapter{Conclusion}
